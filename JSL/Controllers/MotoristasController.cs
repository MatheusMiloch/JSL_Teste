...
namespace JSL.Controllers
{
    public class MotoristasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nomeMotorista,enderecoMotorista,cidadeMotorista,estadoMotorista,marcaCaminhao,modeloCaminhao,placaCaminhao,qntEixos")] Motorista motorista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nomeMotorista,enderecoMotorista,cidadeMotorista,estadoMotorista,marcaCaminhao,modeloCaminhao,placaCaminhao,qntEixos")] Motorista motorista)
        {
            if (id != motorista.Id)
            {
                return NotFound();
